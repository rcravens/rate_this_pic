    ...
    <nav class="bg-gray-800">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/upload.php" class="rounded-md px-3 py-2 text-sm font-medium bg-gray-900 text-white" aria-current="page">Upload Photo</a>
        ...
        <div class="hidden md:hidden" id="mobile_menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="/upload.php" class="block rounded-md px-3 py-2 text-base font-medium bg-gray-900 text-white" aria-current="page">Upload Photo</a>
